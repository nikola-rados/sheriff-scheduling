            ...
            <b-tooltip :target="'trainingIcon'+index" variant="warning" show.sync ="true" triggers="hover">
                ...
                <b-table  
                    ...
                    <template v-slot:cell(startTime)="data" >
                        ...
                        <span v-else>{{data.value | beautify-time}}</span> 
                    </template>
...
<script lang="ts">
    ...
    @Component
    export default class TrainingConflicts extends Vue {        
        ...
        @Prop({required: true})
        trainingConflicts!: conflictsInfoType[];               
        ...
        {   
            ...
            console.log(this.trainingConflicts)
            // if (this.trainingConflicts.length > 0 ) {                
            //     this.userTrainingInfo = [];            
            //     for(const trainingConflict of this.trainingConflicts)
            //     {
