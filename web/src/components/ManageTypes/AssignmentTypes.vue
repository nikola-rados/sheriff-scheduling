                    ...
                    <b-table
                        ...
                        responsive="sm"> 
                            ...
                            <template v-slot:cell(edit)="data" >                                  
                                ...
                                <b-button v-if="hasPermissionToExpireManageTypes && data.item['_rowVariant']" class="my-0 ml-2 py-0 px-1" size="sm" variant="warning" @click="confirmUnexpireAssignment(data.item)"><b-icon icon="arrow-counterclockwise" font-scale="1.25" variant="danger"/></b-button>
